...
const INTERSTITIAL_STEPS: StepType[] = [
  "social-proof",
  "outcome-preview",
  "relatability",
  "loading",
...
export function OnboardingFlow() {
  ...
  useEffect(() => {
    if (
      ...
      stepType === "outcome-preview" ||
      stepType === "relatability"
    ) {
  ...
  const submitData = useCallback(async () => {
    if (hasStartedSubmission) return;
  ...
  // Handle popup and submission after progress completes
  useEffect(() => {
    if (stepType === "loading" && loadingProgress === 100) {
      if (!isAuthenticated) {
        if (!isWaitingForAuth) {
          setIsWaitingForAuth(true);
        }
        if (searchParams.get("auth_mode") !== "signup") {
  ...
  }, [loadingProgress, isAuthenticated, stepType, setSearchParams, submitData, isWaitingForAuth, searchParams, hasStartedSubmission]);

  // Automatically submit after login if we were waiting
  useEffect(() => {
    if (isWaitingForAuth && isAuthenticated && loadingProgress === 100) {
      setIsWaitingForAuth(false);
      
      // Remove auth_mode from URL if it exists
      if (searchParams.get("auth_mode")) {
  ...
  }, [isAuthenticated, isWaitingForAuth, loadingProgress, searchParams, setSearchParams, submitData, hasStartedSubmission]);

  const canProceed = () => {
    switch (stepType) {
      case "identity":
        return tempOnboardingData.niche !== null;
      case "habit":
        return tempOnboardingData.addiction !== null;
      case "intensity":
        return tempOnboardingData.severity !== null;
      case "pain-points":
        return tempOnboardingData.painPoints.length > 0;
      case "commitment":
        return true;
      default:
        return true;
          ...
          >
            ...
            >
              <h2 className="text-2xl sm:text-3xl font-bold">
                Trusted by <span className="text-primary">120,000+</span> users
                worldwide
              </h2>
              <p className="text-muted-foreground text-lg max-w-md mx-auto">
                People your age are using this to regain focus, energy, and
                control.
              </p>
            </motion.div>
      ...
      case "outcome-preview":
        return (
          ...
          >
            ...
            >
              What users like you achieve in{" "}
            ...
            >
              {[
                {
                  icon: Clock,
                  text: "+2–3 hrs/day reclaimed",
                  color: "text-blue-500",
                },
                {
                  icon: Moon,
                  text: "Better sleep in 7–10 days",
                  color: "text-purple-500",
                },
                {
                  icon: Brain,
                  text: "Stronger focus without willpower",
                  color: "text-orange-500",
                },
                {
                  icon: Battery,
                  text: "Less guilt, more control",
              ...
              {[
                {
                  id: "mild",
                  label: "Occasionally",
                  description: "I still have control",
                  emoji: "🟢",
                ...
                },
                {
                  id: "moderate",
                  label: "Often",
                  description: "It's becoming a problem",
                  emoji: "🟡",
                ...
                },
                {
                  id: "severe",
                  label: "Daily",
                  description: "It feels hard to stop",
                  emoji: "🔴",
                ...
                <motion.button
                  ...
                  onClick={() =>
                    setSeverity(option.id as "mild" | "moderate" | "severe")
                  }
              ...
              <div className="relative">
                ...
                <div className="relative bg-card border border-border rounded-2xl p-8">
                  ...
                  <blockquote className="text-xl sm:text-2xl font-medium italic mb-4">
                    "I didn't realize how much this habit drained me until I saw
                    it clearly."
                  </blockquote>
